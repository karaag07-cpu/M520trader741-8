...
function Home() {
  ...
  return (
    <main className="relative min-h-dvh overflow-hidden bg-[#faf7f2] dark:bg-[#0d0e0a] selection-botanical pb-32">
      ...
      <header className="relative z-20 pt-12 px-6 flex justify-center">
        <div className="flex items-center gap-6 text-sage-bold">
          <FlowerIcon src="/flower-rose.svg" className="w-10 h-10" />
          <span className="text-sm tracking-[0.6em] font-bold uppercase">Floral Analytics</span>
          <FlowerIcon src="/flower-lavender.svg" className="w-10 h-10" />
        </div>
      </header>

      <section className="relative flex flex-col items-center pt-24 pb-32 px-6 text-center z-10">
        <div className="mb-16 flex items-center gap-8 text-rose-bold">
           <MoonIcon className="w-10 h-10 -rotate-12" />
           <div className="h-[3px] w-32 bg-current" />
           <span className="text-[12px] tracking-[1em] uppercase font-black">
        ...
        <h1 className="max-w-6xl text-7xl md:text-9xl font-bold tracking-tight text-[#1a1c17] dark:text-white mb-12">
      ...
      <section className="max-w-[1500px] mx-auto px-6 py-20 relative z-10">
        <div className="relative min-h-[1100px] md:min-h-[1500px]">
          {strategies.map((s, i) => (
            <div 
              key={i} 
              className={`organic-card absolute group hover:-translate-y-8 transition-all duration-1000 ${s.shape} ${s.offset} ${s.borderColor}`}
              style={{ 
            ...
            >
              ...
              <FlowerIcon src={s.flower} className="flower-accent -top-16 -right-16 w-40 h-40 opacity-100" />
              
              <div className="flex justify-center items-center mb-14 relative z-10 w-full">
                <span className={`font-botanical italic text-6xl ${s.color} mr-6`}>{s.id}</span>
                <MoonIcon className={`w-8 h-8 ${s.color}`} />
              </div>
              
              <h3 className="text-4xl md:text-5xl font-bold text-[#1a1c17] dark:text-white mb-10 tracking-widest relative z-10">
                {s.name}
              </h3>
      ...
      <section className="mt-80 px-6 relative z-10">
        <div className="max-w-7xl mx-auto rounded-[6rem] bg-rose-bold text-white p-24 md:p-48 text-center shadow-[0_80px_150px_-30px_rgba(138,74,74,0.6)] overflow-hidden relative">
          ...
          <div className="relative z-10">
            <h2 className="text-6xl md:text-9xl font-bold mb-16 tracking-tight uppercase">Vibrant Precision</h2>
            <div className="w-64 h-[4px] bg-white mx-auto mb-16" />
            <p className="text-white text-3xl md:text-5xl font-medium leading-tight max-w-5xl mx-auto font-botanical italic">
            ...
            <div className="mt-28 inline-block px-20 py-10 rounded-full border-4 border-white text-white uppercase tracking-[0.6em] text-[16px] font-black hover:bg-white hover:text-rose-bold transition-all duration-700 cursor-default backdrop-blur-md">
      ...
      <footer className="pt-80 pb-20 px-6 text-center relative">
        <div className="absolute top-40 left-1/2 -translate-x-1/2 w-full flex justify-center gap-16">
           <FlowerIcon src="/flower-rose.svg" className="w-32 h-32" />
           <FlowerIcon src="/flower-lavender.svg" className="w-32 h-32" />
           <FlowerIcon src="/flower-sage.svg" className="w-32 h-32" />
        </div>
        
        <div className="flex flex-col items-center gap-16 relative z-10">
          <div className="flex gap-20 text-rose-bold">
